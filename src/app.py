...
# ----- Opciones de los controles (por ahora hardcodeadas) -----
...
DISTRITOS = [
    ...
    # Más adelante añadiremos el resto
]

DIAS_SEMANA = [
    {"label": "Lunes", "value": "Lunes"},
    {"label": "Martes", "value": "Martes"},
    {"label": "Miércoles", "value": "Miércoles"},  # alineado con el dataset
...
# ----- Callback: conecta el formulario con el modelo y los gráficos -----
...
def actualizar_salida(tipo_persona, tipo_vehiculo, rango_edad, sexo,
    ...
    explicacion = (
        f"Con el perfil seleccionado, la franja actual presenta un riesgo aproximado "
        f"del {riesgo_pct} %. Las franjas alternativas sugeridas muestran un riesgo "
        f"algo menor manteniendo fijo el resto del escenario. "
        f"Esta estimación se basa en un modelo estadístico entrenado con datos históricos "
        f"de la ciudad de Madrid y debe interpretarse solo con fines informativos."
    )
